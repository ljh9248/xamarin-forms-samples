...
namespace CustomRenderer.Tizen
{
    ...
    {
        private static readonly ElmSharp.Size WindowSize = Forms.Context.MainWindow.ScreenSize;
        ...
        {
            var minimumHeight = WindowSize.Height > 800 ? 96 : 76;
            if (part == "elm.swallow.content")
            {
                DataSource itemSource = (DataSource)data;
                ElmSharp.Box mainBox = new ElmSharp.Box(Forms.Context.MainWindow);
                ...
                ElmSharp.Box contentBox = new ElmSharp.Box(Forms.Context.MainWindow);
                contentBox.MinimumHeight = minimumHeight;
                contentBox.IsHorizontal = true;
                contentBox.SetAlignment(-1, -1);
                contentBox.Show();

                ElmSharp.Box left = new ElmSharp.Box(Forms.Context.MainWindow);
                ...
                ElmSharp.Label titleName = new ElmSharp.Label(Forms.Context.MainWindow);
                ...
                ElmSharp.Label titleCategory = new ElmSharp.Label(Forms.Context.MainWindow);
                ...
                ElmSharp.Box right = new ElmSharp.Box(Forms.Context.MainWindow);
                right.Show();
